...
const UserInfo = props => <div>
    ...
    <p>{props.firstName} {props.lastName}
    	<br />Expected Date: {props.date} Time: {props.time}<br />
    	<button type="button" onClick={props.handleStartChat} className="btn btn-success">
    	<span className="glyphicon glyphicon-comment" aria-hidden="true"> 
    	</span> Contact Your Service Provider</button>
    </p>
    </div>;
